...
// ─── Lazy Load các component nặng, không cần xuất hiện ngay lập tức ───────────
// React.lazy() + Suspense giúp tách CheckoutModal và ChatBot thành các
// JS chunk riêng biệt → trình duyệt chỉ tải khi cần → giảm Initial Bundle size.
